	...
	protected void initializeCodeFragments() {
			...
			public void execute(MD2Application app) {
				app.getMappings().add(
					new StringTextViewMapping<de.wwu.masterthesis.reference.android.models.Group>(
						(TextView) app.getActiveActivity().findViewById(R.id.nameTextInput),
			...
			public void execute(MD2Application app) {
				app.getMappings().add(
					new IntegerTextViewMapping<de.wwu.masterthesis.reference.android.models.Contact>(
						(TextView) app.getActiveActivity().findViewById(R.id.photoTextInput),
		...
		addCodeFragment(new CodeFragment() {
			...
			public void execute(MD2Application app) {
				app.getMappings().add(
					new StringTextViewMapping<de.wwu.masterthesis.reference.android.models.Contact>(
						(TextView) app.getActiveActivity().findViewById(R.id.firstnameTextInput),
						app.findContentProviderByType(ContactContentProvider.class),
						new PathResolver<de.wwu.masterthesis.reference.android.models.Contact, String>() {
							public String retrieveValue(de.wwu.masterthesis.reference.android.models.Contact entity) {
		...
		addCodeFragment(new CodeFragment() {
			...
			public void execute(MD2Application app) {
				app.getMappings().add(
					new IntegerTextViewMapping<de.wwu.masterthesis.reference.android.models.Contact>(
						(TextView) app.getActiveActivity().findViewById(R.id.phoneTextInput),
						app.findContentProviderByType(ContactContentProvider.class),
						new PathResolver<de.wwu.masterthesis.reference.android.models.Contact, Integer>() {
							public Integer retrieveValue(de.wwu.masterthesis.reference.android.models.Contact entity) {
		...
		addCodeFragment(new CodeFragment() {
			...
			public void execute(MD2Application app) {
				app.getMappings().add(
					new StringTextViewMapping<de.wwu.masterthesis.reference.android.models.Contact>(
						(TextView) app.getActiveActivity().findViewById(R.id.emailTextInput),
						app.findContentProviderByType(ContactContentProvider.class),
						new PathResolver<de.wwu.masterthesis.reference.android.models.Contact, String>() {
							public String retrieveValue(de.wwu.masterthesis.reference.android.models.Contact entity) {
		...
		addCodeFragment(new CodeFragment() {
			...
			public void execute(MD2Application app) {
				app.getMappings().add(
					new StringTextViewMapping<de.wwu.masterthesis.reference.android.models.Contact>(
						(TextView) app.getActiveActivity().findViewById(R.id.streetTextInput),
						app.findContentProviderByType(ContactContentProvider.class),
						new PathResolver<de.wwu.masterthesis.reference.android.models.Contact, String>() {
							public String retrieveValue(de.wwu.masterthesis.reference.android.models.Contact entity) {
		...
		addCodeFragment(new CodeFragment() {
			...
			public void execute(MD2Application app) {
				app.getMappings().add(
					new StringTextViewMapping<de.wwu.masterthesis.reference.android.models.Contact>(
						(TextView) app.getActiveActivity().findViewById(R.id.cityTextInput),
						app.findContentProviderByType(ContactContentProvider.class),
						new PathResolver<de.wwu.masterthesis.reference.android.models.Contact, String>() {
							public String retrieveValue(de.wwu.masterthesis.reference.android.models.Contact entity) {
		...
		addCodeFragment(new CodeFragment() {
			...
			public void execute(MD2Application app) {
				app.getMappings().add(
					new IntegerTextViewMapping<de.wwu.masterthesis.reference.android.models.Contact>(
						(TextView) app.getActiveActivity().findViewById(R.id.zipCodeTextInput),
						app.findContentProviderByType(ContactContentProvider.class),
						new PathResolver<de.wwu.masterthesis.reference.android.models.Contact, Integer>() {
							public Integer retrieveValue(de.wwu.masterthesis.reference.android.models.Contact entity) {
		...
		addCodeFragment(new CodeFragment() {
			...
			@Override
			public void execute(MD2Application app) {
				new IsIntValidator("", (TextView)app.getActiveActivity().findViewById(R.id.phoneTextInput), app, "phoneTextInput");
			}
		});
		...
		addCodeFragment(new CodeFragment() {
			...
			@Override
			public void execute(MD2Application app) {
				new IsIntValidator("", (TextView)app.getActiveActivity().findViewById(R.id.zipCodeTextInput), app, "zipCodeTextInput");
				new NumberRangeValidator("", (TextView)app.getActiveActivity().findViewById(R.id.zipCodeTextInput), app, "zipCodeTextInput", 1000.0, 99999.0);
			}
		});
		...
		addCodeFragment(new CodeFragment() {
			...
			@Override
			public void execute(MD2Application app) {
				new NotNullValidator("", (TextView)app.getActiveActivity().findViewById(R.id.nameTextInput), app, "nameTextInput");
			}
		});
		...
		addCodeFragment(new CodeFragment() {
			...
			@Override
			public void execute(MD2Application app) {
				new NotNullValidator("", (TextView)app.getActiveActivity().findViewById(R.id.firstnameTextInput), app, "firstnameTextInput");
			}
		});
		...
		addCodeFragment(new CodeFragment() {
			...
			@Override
			public void execute(MD2Application app) {
				new IsIntValidator("", (TextView)app.getActiveActivity().findViewById(R.id.photoTextInput), app, "photoTextInput");
			}
		});
