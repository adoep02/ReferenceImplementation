...
public class GroupTabFragment extends Fragment {
	...
	private void initializeEvents() {
		getView().findViewById(R.id.nameTextInput2).setOnFocusChangeListener(new MD2FocusLeftEvent(getApp().getEventBus(), "nameTextInput2_FocusLeft"));
		getView().findViewById(R.id.nameTextInput2).setOnClickListener(new MD2TouchEvent(getApp().getEventBus(), "nameTextInput2_Touched"));
		getView().findViewById(R.id.saveButton2).setOnClickListener(new MD2TouchEvent(getApp().getEventBus(), "saveButton2_Touched"));
	}
